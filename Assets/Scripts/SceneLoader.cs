...
public class SceneLoader
{
    ...
    private Dictionary<string, LoadSceneTask> m_LoadedTasks = new Dictionary<string, LoadSceneTask>();
    ...
    {
        if (m_LoadedTasks.ContainsKey(sceneName))
        {
        ...
        else 
        {
            LoadSceneTask task = new LoadSceneTask(sceneName, setSceneAsActive, (loadedScene) => 
            {
                ...
                m_LoadedTasks.Remove(loadedScene.name);
            });

            m_LoadedTasks.Add(sceneName, task);
        }
    }
}
